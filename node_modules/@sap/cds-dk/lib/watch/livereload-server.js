const DEBUG = /\b(y|all|cli|watch|livereload)\b/.test (process.env.DEBUG) ? ((..._) => console.debug ('[cli] -', ..._)) : undefined
...
const watchExcludes = new RegExp(`${escapedSep}(node_modules|\\.git|dist)(${escapedSep}|$)|@cds-models${escapedSep}|@types${escapedSep}`)
...
module.exports = class LiveReload {
  async start(port, cwd, delay=0) {
    ...
    return new Promise ((resolve, reject) => {
      ...
      const watcher = watch (cwd||process.cwd(),{ filter, ignore: watchExcludes })
