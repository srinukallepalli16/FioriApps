...
const { BuildError, relativePaths, BuildMessage, hasOptionValue, getWorkspacePaths } = require('../../util')
...
class HanaBuildPlugin extends InternalBuildPlugin {
    ...
    async _copyResources(src, dest) {
        ...
        for (const csvDir of csvDirs) {
            allFiles.push(...await find(csvDir, { filter: entry => regexData.test(entry) && !cds.utils.isdir(entry) }))
        }
