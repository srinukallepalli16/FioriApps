...
const { hasJavaNature, getDefaultModelPaths, hasOptionValue, BuildError } = require('./util')
const { OPTION_WS, IGNORE_DEFAULT_MODELS, NODEJS_MODEL_EXCLUDE_LIST, BUILD_TASK_NODEJS, BUILD_TASK_NODE_CF } = require("./constants")
const DEBUG = cds.debug('cli|build')

module.exports = class BuildTaskFactory {
    constructor(options) {
    ...
    static _getExistingTasks() {
        return Array.isArray(cds.env.build?.tasks) ? structuredClone(cds.env.build.tasks) : []
    }
